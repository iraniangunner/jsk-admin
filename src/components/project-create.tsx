...
export function ProjectCreate() {
  ...
  // Update mutation
  const { mutate: createProjectMutation, isPending: isSaving } = createProject()
  // Get categories
  ...
  const onSubmit = async (data: ProjectFormData) => {
    try {
      ...
      toast.error(error instanceof Error ? error.message : "خطا در ارسال اطلاعات")
    }
  }
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="عنوان پروژه را وارد کنید" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Enter project title" dir="ltr" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="نام کارفرما را وارد کنید" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Enter employer name" dir="ltr" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="تاریخ شروع را وارد کنید (مثال: 1402-06-15)" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>حداقل یک دسته‌بندی را انتخاب کنید</FormDescription>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="مکان پروژه را وارد کنید" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Enter project location" dir="ltr" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="توضیحات پروژه را وارد کنید" className="min-h-[120px]" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <div className="space-y-4">
                        ...
                        >
                          <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p className="mb-2 text-sm text-muted-foreground">
                              <span className="font-semibold">برای آپلود ویدیو کلیک کنید</span>
                            </p>
                            <p className="text-xs text-muted-foreground">MP4 (حداکثر 100MB)</p>
                          </div>
                          <Input
                            id="video-upload"
                            type="file"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">حداقل یک تصویر آپلود کنید</p>
                    <div className="mt-2">
                      <div className="flex items-center justify-center w-full">
                        <label
                        ...
                        >
                          <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            <Upload className="w-8 h-8 mb-2 text-muted-foreground" />
                            <p className="mb-2 text-sm text-muted-foreground">
                              <span className="font-semibold">برای آپلود تصاویر کلیک کنید</span>
                            </p>
                ...
                <div className="flex justify-center">
                  <Button type="submit" disabled={isSaving} className="cursor-pointer px-8 py-2">
                    {isSaving ? (
                      <>
